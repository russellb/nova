...
class ComputeAPI(nova.rpc.proxy.RpcProxy):
    ...
    def post_live_migration_at_destination(self, ctxt, instance_id,
            block_migration, host):
        return self.call(ctxt,
                self.make_msg('post_live_migration_at_destination',
                instance_id=instance_id, block_migration=block_migration),
    ...
    def pre_live_migration(self, ctxt, instance_id, block_migration, disk,
            host):
    ...
    def rollback_live_migration_at_destination(self, ctxt, instance_id, host):
